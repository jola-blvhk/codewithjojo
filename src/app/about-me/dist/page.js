            ...
            react_1["default"].createElement("section", { className: "lg:w-[70%]" },
                ...
                react_1["default"].createElement("div", { className: "md:mt-14  space-y-4 text-sm sm:text-base  md:text-lg md:leading-8" },
                    ...
                    react_1["default"].createElement("p", null,
                        ...
                        "It\u2019s an app where users type a story prompt (e.g., \"A spaceship lands in a medieval kingdom\"), and the AI generates a story in real-time, streaming each paragraph as it\u2019s created.")),
                react_1["default"].createElement("div", { className: "mt-6" },
                    react_1["default"].createElement("h2", { className: "text-lg md:text-xl font-semibold" }, "What I Bring to the Table :"),
