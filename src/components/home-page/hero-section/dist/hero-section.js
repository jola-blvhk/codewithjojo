...
var HeroSection = function () {
    ...
    return (react_1["default"].createElement("div", { className: "relative pt-4 pb-6 md:py-9 lg:flex justify-between items-center" },
        react_1["default"].createElement("div", { className: "sm: w-full  lg:w-[95%] xl:w-[60%]" },
            ...
            react_1["default"].createElement("p", { className: "lg:w-[80%] h-16  md:h-20 sm:mt-3 leading-7 text-sm sm:text-base sm:leading-9   md:leading-9 lg:leading-10 lg:text-lg md:text-xl" },
                react_1["default"].createElement(ReactTyped, { strings: [
                    ...
                    ], typeSpeed: 60, backSpeed: 20, loop: true, showCursor: false })),
