...
var profile_picture_png_1 = require("../../../../public/assets/profile-picture.png");
    ...
    return (react_1["default"].createElement("div", { className: "relative pt-4 pb-6 md:py-9 lg:flex justify-between items-center" },
        react_1["default"].createElement("div", { className: "sm: w-full  lg:w-[95%] xl:w-[60%]" },
            ...
            react_1["default"].createElement("h1", { className: "font-bold mt-3 md:mt-4  text-3xl  sm:text-4xl md:text-5xl xl:text-6xl leading-[70px] sm:leading-[80px] lg:leading-[96px] xl:leading-[96px] " },
                react_1["default"].createElement(image_1["default"], { src: isSmallScreen ? profile_picture_png_1["default"] : profile_picture_svg_1["default"], width: 50, height: 50, alt: "Jojo", quality: 100, className: "inline mr-5 sm:mr-7  md:mr-10  w-[60px] sm:w-[90px] md:w-[120px] h-auto rounded-xl" }),
                " ",
                "Hi, I\u2019m Oluremi !",
            ...
            react_1["default"].createElement("button", { onClick: function () {
                ...
                }, className: " text-white mt-2 sm:mt-3 py-2 px-[22.3px]  sm:py-5 sm:px-12 rounded-[50px] text-sm md:text-base lg:text-lg bg-black" }, "Send a mail")),
