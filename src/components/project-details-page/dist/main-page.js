            ...
            React.createElement("main", { className: "paddingX" },
                React.createElement("section", { className: "maxWidthSection" },
                    ...
                    React.createElement("div", { className: "grid sm:flex gap-2 mt-5 sm:mt-6 justify-center items-center" },
                        React.createElement("a", { href: details.liveDemoLink, target: "_blank", rel: "noopener noreferrer", className: "grid" },
                            " ",
                        ...
                        details.isPublicRepo && (React.createElement("a", { href: details.github, target: "_blank", rel: "noopener noreferrer", className: "grid " },
                            " ",
