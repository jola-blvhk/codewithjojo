...
function ProjectDetails(_a) {
    ...
    var _d = react_1.useState(false), isLargeScreen = _d[0], setIsLargeScreen = _d[1];
    ...
    console.log(details);
    return (React.createElement(React.Fragment, null, !details ? (React.createElement("p", null, "Loading project data")) : (React.createElement("section", { className: "pt-10 sm:pt-16  mx-auto min-h-screen" },
        isLargeScreen ? (
        // Grid view for large screens
        React.createElement("div", { className: "paddingX" },
            React.createElement("div", { className: "maxWidthSection grid grid-cols-3 gap-6" }, imageUrls.map(function (src, i) { return (React.createElement(image_1["default"], { src: src, key: i, alt: "Project Image " + (i + 1), className: "w-full h-auto rounded-xl drop-shadow-xl ", width: 500, height: 300 })); })))) : (
        ...
        React.createElement("main", { className: "paddingX" },
            React.createElement("section", { className: "maxWidthSection" },
                ...
                React.createElement("p", { className: "text-center m-auto lg:w-[80%] text-sm sm:text-base md:text-lg lg:text-xl xl-text-2xl mt-3 lg:mt-5 leading-6 sm:leading-8 md:leading-8 lg:leading-10 " },
                    React.createElement(react_typed_1.ReactTyped, { startWhenVisible: true, strings: [details.description], typeSpeed: 60, backSpeed: 20, loop: false, showCursor: true })),
